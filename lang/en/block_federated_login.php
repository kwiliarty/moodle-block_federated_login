...
$string['configlogcookieuse']            = 'If checked, the block will add cookie use information to your Moodle logs';
...
$string['event_federated_user_loggedin'] = 'User logged in';
...
$string['logcookieuse']                  = 'Log cookie use';
